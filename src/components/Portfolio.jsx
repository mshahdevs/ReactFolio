...
import project1 from '../assets/nav1.jpeg'
import project2 from '../assets/nav2.jpeg'
import project3 from '../assets/nav3.jpeg'
       ...
       {projects.map((project,index)=>(
        <div key={index} className={`flex flex-col md:flex-row ${index % 2 !== 0 ? 'md:flex-row-reverse': ''} mb-12 `}>
          <div className='w-full md:w-1/2  p-4'>
            <img src={project.img} className='w-full h-full object-cover rounded-xl shadow-lg' alt={project.title} />
          </div>
