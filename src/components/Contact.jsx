...
export function Contact() {
  return (
    <div className='px-6 max-w-[1000px] mx-auto md:my-12' id='contact'>
      <div
       className='grid md:grid-cols-2 place-content-start'
      >
        
        <div >
           <div className='text-gray-300 my-3'>
            <h3 className='text-4xl text-left font-semibold mb-5'>About <span>Me</span> </h3>
            <p className='text-justify leading-7 w-11/12 mx-auto'>
            I am a web developer who loves what I do. I know how to use HTML, CSS, and JavaScript.
I want to use my skills and creativity to help with exciting web projects. I pay attention
to details and focus on making websites that users enjoy. I always look for ways to learn
more and get better in web development.
        ...
        <form action="https://getform.io/f/bqoknypb" method='POST' className='max-w-6xl flex flex-col gap-2 p-5 md:p-12' id='form'>
         ...
         <textarea  name="textarea" id="textarea" placeholder='Your Messge ...'
         cols={30}
         rows={4}
       
         className='mb-2 resize-none w-full bg-gray-50 rounded-xl border border-y-purple-600 outline-purple-400 py-2 pl-2 pr-4' />
         <button type='submit' className='w-full py-3 rounded-xl text-gray-100 font-semibold text-xl bg-primary-color'>Send Message</button>
        </form>
      </div>
    </div>
  )
